...
<html>
	...
	<body>
		<div class="body-box">
			...
			<form method="post" action="admin_updateInfo.do" onsubmit="return check();">
				<table width="100%" class="pn-ftable" cellpadding="2" cellspacing="1" border="0">
					<tr>
						<td width="20%" class="pn-flabel pn-flabel-h">登&nbsp;录&nbsp;名：</td>
						<td width="80%" class="pn-fcontent"><input type="text" name="admin.username" value="${admin.username}" readonly size="20"/></td>
					</tr>
					<tr>
						<td width="20%" class="pn-flabel pn-flabel-h">真实姓名：</td>
						<td width="80%" class="pn-fcontent"><input type="text" name="admin.name" value="${admin.name}" size="20"/></td>
					</tr>
					<tr>
