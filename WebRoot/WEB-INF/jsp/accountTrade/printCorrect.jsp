  ...
  <!--startprint-->
   <table width="450" class="pn-ftable" cellpadding="1" cellspacing="1" border="0" height="20" align="center" style="background-color: #FFFFFF;" >
					...
					<td colspan="4" class="pn-fbutton">
							<input type="text" value=" 冲正信息回执 " style="BORDER-BOTTOM: 0px; BORDER-LEFT: 0px; BACKGROUND: none transparent scroll repeat 0% 0%; BORDER-TOP: 0px; BORDER-RIGHT: 0px"/> &nbsp;
					</td>
					</tr>
					</table>  
				...
				<table width="700" class="pn-ftable" cellpadding="0" cellspacing="0" border="1" height="200" align="center">
					...
					<tr>
					 <td class="pn-flabel pn-flabel-h">冲正前余额（元）</td>
					...
					<tr>
					 <td class="pn-flabel pn-flabel-h">冲正金额（元）</td>
					...
					<tr>
					 <td class="pn-flabel pn-flabel-h">冲正后余额（元）</td>
					...
					<tr>
					  <td class="pn-flabel pn-flabel-h">卡余额：</td>
					  <td  class="pn-fcontent"><input type="text" name="accountTrade.cardBalance" value="${accountTrade.cardBalance}" readonly="true" style="BORDER-BOTTOM: 0px; BORDER-LEFT: 0px; BACKGROUND: none transparent scroll repeat 0% 0%; BORDER-TOP: 0px; BORDER-RIGHT: 0px"/></td>
					</tr>
					</c:if>-->
					<tr>
					 <td class="pn-flabel pn-flabel-h">被冲正记录交易时间</td>
					 <td  class="pn-fcontent"><input type="text" name="opTime" value="${opTime}"  readonly="true" style="BORDER-BOTTOM: 0px; BORDER-LEFT: 0px; BACKGROUND: none transparent scroll repeat 0% 0%; BORDER-TOP: 0px; BORDER-RIGHT: 0px"/></td>
					</tr>
					<tr>
					 <td class="pn-flabel pn-flabel-h">被冲正记录交易流水线</td>
					 <td  class="pn-fcontent"><input type="text" name="accountTrade.backoutedListNo" value="${accountTrade.backoutedListNo}"  size="30" readonly="true" style="BORDER-BOTTOM: 0px; BORDER-LEFT: 0px; BACKGROUND: none transparent scroll repeat 0% 0%; BORDER-TOP: 0px; BORDER-RIGHT: 0px"/></td>
					</tr>
					<tr>
					 <td class="pn-flabel pn-flabel-h">冲正时间</td>
