...
<html>
	<head>
		...
		function check(){
	      if((document.getElementsByName("idCardInfoTemp.idcardNo")[0].value).trim()!=(document.getElementsByName("idcardNo")[0].value).trim()){
	...
	<body>
		<div class="body-box">
			...
			<form id="dataform" method="post" action="iDCard_updateIDCardInfoEdit.do" onsubmit="return check();" >
				<table width="100%" class="pn-ftable" cellpadding="2" cellspacing="1" border="0">
					...
					<tr>
						...
						<input type="hidden" name="idcardNo" value="${idCardInfoTemp.idcardNo}"/>
