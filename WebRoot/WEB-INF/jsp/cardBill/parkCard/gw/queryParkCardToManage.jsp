					...
					<c:forEach items="${listUserCardInfo}" var="itemUserCardInfo">
						<tr onmouseover="this.className='pn-lhover'" onmouseout="this.className=''" align="center" onclick="getRowIndex(this)"> 
							...
							<%--<td ><input  type="text"  value="${itemUserCardInfo.address}" size="25" style="BORDER-BOTTOM: 0px; BORDER-LEFT: 0px; BACKGROUND: none transparent scroll repeat 0% 0%; BORDER-TOP: 0px; BORDER-RIGHT: 0px"/></td>
							 --%><td style="white-space:nowrap;padding-left:5px;padding-right:5px;"><a href="javascript:userCardInfoList(${itemUserCardInfo.recNO},${pager.pageSize},${pager.currentPage})" class="pn-loperator">修改</a>┆<a href="javascript:cancel('${itemUserCardInfo.cardNo}')" class="pn-loperator">注销</a></td>                               
						</tr>
					</c:forEach>
				</tbody>
			</table>
