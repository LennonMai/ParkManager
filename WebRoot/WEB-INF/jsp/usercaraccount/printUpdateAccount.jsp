...
<html>
	<head>
		...
		if("${result}"=="SUCCESS")
				alert("打印成功");
		 function doPrint() { 
             window.open("userCarAccount_printUpdate.do?accountTemp.sys_id=${accountTemp.sys_id}");
            } 
        </script> 
		...
		<div class="body-box">
			<div class="rhead">
			 ...
			 <form method="post" action="" >  
			       <!--<form method="post" action="userCarAccount_setPrintNumber.do" >  -->
				 ...
				 <table width="700" class="pn-ftable" cellpadding="2" cellspacing="1" border="0" height="20" style="background-color: #FFFFFF;">
					...
					<table width="800" class="pn-ftable" cellpadding="2" cellspacing="1" border="0" height="345">
					...
					<tr>
					 ...
					 <tr>
					  ...
					  <td class="pn-flabel pn-flabel-h">车&nbsp;颜&nbsp;色</td>
					   <td class="pn-fcontent"><input type="text" name="car1.carColour" value="${carTemp.carColour}" style="BORDER-BOTTOM: 0px; BORDER-LEFT: 0px; BACKGROUND: none transparent scroll repeat 0% 0%; BORDER-TOP: 0px; BORDER-RIGHT: 0px"/></td>
					...
					<tr>
                      ...
                      <!--    <td class="pn-fbutton">	<input type="submit" value="打印成功 " /></td>
						<td class="pn-fbutton"></td>-->
					</tr>
					</table>
