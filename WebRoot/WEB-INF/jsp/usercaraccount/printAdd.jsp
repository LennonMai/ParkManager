...
<html>
  ...
  <body>
   <!--startprint--> 
   <table width="450" class="pn-ftable" cellpadding="2" cellspacing="1" border="0" height="20" align="center" style="background-color: #FFFFFF;" >
					<tr>
				...
				<table width="700" class="pn-ftable" cellpadding="0" cellspacing="0" border="1" height="345" align="center">
					...
					<tr>
					  ...
					  <c:if test="${carTemp.carType==1}"><td colspan="3" class="pn-fcontent"><input type="text" name="car1.carType" value="小轿车、吉普车、的士头人货车、摩托车"  size="77" readonly="true" style="BORDER-BOTTOM: 0px; BORDER-LEFT: 0px; BACKGROUND: none transparent scroll repeat 0% 0%; BORDER-TOP: 0px; BORDER-RIGHT: 0px"/></td></c:if>
					    <c:if test="${carTemp.carType==2}"><td colspan="3" class="pn-fcontent"><input type="text" name="car1.carType" value="面包车、小型人货车、轻型货车、小型客车"  size="77" readonly="true" style="BORDER-BOTTOM: 0px; BORDER-LEFT: 0px; BACKGROUND: none transparent scroll repeat 0% 0%; BORDER-TOP: 0px; BORDER-RIGHT: 0px"/></td></c:if>
					     <c:if test="${carTemp.carType==3}"><td colspan="3" class="pn-fcontent"><input type="text" name="car1.carType" value="中型客车、大型客车、中型货车"  size="77" readonly="true" style="BORDER-BOTTOM: 0px; BORDER-LEFT: 0px; BACKGROUND: none transparent scroll repeat 0% 0%; BORDER-TOP: 0px; BORDER-RIGHT: 0px"/></td></c:if>
					      <c:if test="${carTemp.carType==4}"><td colspan="3" class="pn-fcontent"><input type="text" name="car1.carType" value="大型客车、大型货车、大型拖（挂）车、20英尺集装箱车"  size="77" readonly="true" style="BORDER-BOTTOM: 0px; BORDER-LEFT: 0px; BACKGROUND: none transparent scroll repeat 0% 0%; BORDER-TOP: 0px; BORDER-RIGHT: 0px"/></td></c:if>
				           <c:if test="${carTemp.carType==5}"><td colspan="3" class="pn-fcontent"><input type="text" name="car1.carType" value="重型货车、重型拖（挂）车、40英尺集装箱车"  size="77" readonly="true" style="BORDER-BOTTOM: 0px; BORDER-LEFT: 0px; BACKGROUND: none transparent scroll repeat 0% 0%; BORDER-TOP: 0px; BORDER-RIGHT: 0px"/></td></c:if>
					...
					<tr>
					  ...
					  <td colspan="3" class="pn-fcontent"><input type="text" name="accountTemp2.remark" value="${accountTemp.remark}" size="77" readonly="true" style="BORDER-BOTTOM: 0px; BORDER-LEFT: 0px; BACKGROUND: none transparent scroll repeat 0% 0%; BORDER-TOP: 0px; BORDER-RIGHT: 0px"/></td>
					</tr>	
				    <!--endprint-->
					<tr>
