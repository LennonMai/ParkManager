...
<%@ page contentType="text/html; charset=GBK" language="java" pageEncoding="gbk" isErrorPage="true"%>
			...
			<table width="100%" cellpadding="2" cellspacing="1" border="0" class="pn-ftable">
				...
				<tr>
					<td class="pn-fcontent" colspan="2" style="padding-left:200px;">
						<input type="button" value=" 关 闭 " onclick="javascript:window.close();return false;"/>&nbsp;&nbsp;
