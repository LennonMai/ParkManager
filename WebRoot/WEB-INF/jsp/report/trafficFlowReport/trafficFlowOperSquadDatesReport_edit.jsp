			...
			function share() {
		  	...
		  	function saveAndPrint(){
				...
				if(countDay > 10) {
			  	...
			  	if(checkTime() == false) {
				    ...
				    window.open("trafficFlowReport_trafficFlowOperSquadDatesReport.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value+"&pSquadNo="+pSquadNo+"&pOperatorNo="+pOperatorNo);
			  ...
			  function saveAndPrintCurrentPage(){
					...
					if(countDay > 10) {
				  	...
				  	if(checkTime() == false) {
						 ...
						 window.belowFrame.location.href="trafficFlowReport_trafficFlowOperSquadDatesReport.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value+"&pSquadNo="+pSquadNo+"&pOperatorNo="+pOperatorNo;
				    }
			  }
		  	...
		  	function saveAndPrintPDF() {
		  		...
		  		if(checkTime() == false) {
		    		...
		    		window.open("trafficFlowReport_trafficFlowOperSquadDatesReportPDF.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value+"&pSquadNo="+pSquadNo+"&pOperatorNo="+pOperatorNo);
		    	}
		  	}
		  	//校验日期
		  	function checkTime() {
