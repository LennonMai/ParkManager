		  	...
		  	function saveAndPrint(){
				...
				if(countDay > 10) {
			  	...
			  	if(checkTime() == false) {
					...
					window.open("otherTollsReport_tollsOperSquadDatesReport.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value+"&pSquadNo="+pSquadNo+"&pOperatorNo="+pOperatorNo);
			  ...
			  function saveAndPrintCurrentPage(){
					...
					if(countDay > 10) {
				  	...
				  	if(checkTime() == false) {
						...
						window.belowFrame.location.href="otherTollsReport_tollsOperSquadDatesReport.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value+"&pSquadNo="+pSquadNo+"&pOperatorNo="+pOperatorNo;
				      	//window.open("otherTollsReport_printBillReport.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value+"&tradeType="+ids,"","location=no,resizable=yes,scrollbars=yes,height=600,width=800,top=0,left=0");
				    }
			  }
		  	...
		  	function saveAndPrintPDF() {
				...
				if(tempBool == false) {
		  		...
		  		if(checkTime() == false) {
		    		...
		    		window.open("otherTollsReport_tollsOperSquadDatesReportPDF.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value+"&pSquadNo="+pSquadNo+"&pOperatorNo="+pOperatorNo);
		    	}
		  	}
		  	//校验日期
		  	function checkTime() {
