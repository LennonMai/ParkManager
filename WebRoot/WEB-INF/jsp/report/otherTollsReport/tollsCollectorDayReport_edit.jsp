		...
		<script type="text/javascript">
		  ...
		  function saveAndPrint() {
			...
			if(countDay > 10) {
		  	...
		  	if(checkTime() == false) {
			    ...
			    window.open("otherTollsReport_tollsCollectorDayReport.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value);
		      	//window.open("otherTollsReport_tollsCollectorDayReport.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value,"","location=no,resizable=yes,scrollbars=yes,height=600,width=800,top=0,left=0");
		    }
		  }
			  ...
			  var countDay = compTime(get("startTime").value, get("endTime").value);
				if(countDay > 10) {
			  	...
			  	if(checkTime() == false) {
					 ...
					 window.belowFrame.location.href="otherTollsReport_tollsCollectorDayReport.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value;
				  }
		  }
		  ...
		  function saveAndPrintPDF() {
		  	if(checkTime() == false) {
		    	...
		    	window.open("otherTollsReport_tollsCollectorDayReportPDF.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value);
		    }
		  }
		  //校验日期
		  function checkTime() {
