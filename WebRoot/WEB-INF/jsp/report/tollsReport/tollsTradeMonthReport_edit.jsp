		...
		<script type="text/javascript">
		  ...
		  function saveAndPrint(){
			...
			if(countMonth > 10) {
		  	...
		  	if(checkTime() == false) {
			    ...
			    window.open("tollsReport_tollsTradeMonthReport.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value);
		      //window.open("tollsReport_tollsTradeMonthReport.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value,"","location=no,resizable=yes,scrollbars=yes,height=600,width=800,top=0,left=0");
		    }
		  }
		  ...
		  function saveAndPrintCurrentPage(){
				...
				if(countMonth > 10) {
			  	...
			  	if(checkTime() == false) {
				    ...
				    window.belowFrame.location.href="tollsReport_tollsTradeMonthReport.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value;
			    }
		  }
		  ...
		  function saveAndPrintPDF(){
		  	if(checkTime() == false) {
		    	...
		    	window.open("tollsReport_tollsTradeMonthReportPDF.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value);
		    }
		  }
		  //校验日期
		  function checkTime() {
