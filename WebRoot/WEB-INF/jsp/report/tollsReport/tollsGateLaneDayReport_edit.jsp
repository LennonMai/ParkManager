		...
		<script type="text/javascript">
		  ...
		  function saveAndPrint(){
			...
			if(countDay > 10) {
		  	...
		  	if(checkTime() == false) {
			     ...
			     window.open("tollsReport_tollsGateLaneDayReport.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value);
			  ...
			  var countDay = compTime(get("startTime").value, get("endTime").value);
				if(countDay > 10) {
			  	...
			  	if(checkTime() == false) {
				     ...
				     window.belowFrame.location.href="tollsReport_tollsGateLaneDayReport.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value;
			      	//window.open("tollsReport_tollsTradeDayReport.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value,"","location=no,resizable=yes,scrollbars=yes,height=600,width=800,top=0,left=0");
			    }
		  }
		  ...
		  function saveAndPrintPDF() {
		  	if(checkTime() == false) {
		    	...
		    	window.open("tollsReport_tollsGateLaneDayReportPDF.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value);
		    }
		  }
		  //校验日期
		  function checkTime() {
