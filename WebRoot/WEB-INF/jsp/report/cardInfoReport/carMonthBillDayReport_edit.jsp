		...
		<script type="text/javascript">
		  ...
		  function saveAndPrint() {
			...
			if(countDay > 10) {
		  	...
		  	if(checkTime() == false) {
			    ...
			    window.open("cardInfoReport_carMonthBillDayReport.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value);
		    }
		  }
			  ...
			  var countDay = compTime(get("startTime").value, get("endTime").value);
				if(countDay > 10) {
			  	...
			  	if(checkTime() == false) {
					...
					window.belowFrame.location.href="cardInfoReport_carMonthBillDayReport.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value;
			    }
		  }
		  ...
		  function saveAndPrintPDF(){
		  	if(checkTime() == false) {
		    	...
		    	window.open("cardInfoReport_carMonthBillDayReportPDF.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value);
		    }
		  }
		  //校验日期
		  function checkTime() {
