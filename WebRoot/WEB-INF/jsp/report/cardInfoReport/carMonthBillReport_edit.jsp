		  ...
		  function saveAndPrint() {
			...
			if(countDay > 10) {
		  	...
		  	if(checkTime() == false) {
			    ...
			    window.open("cardInfoReport_carMonthBillReport.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value);
		    }
		  }
		...
		//生成当前页面HTML报表
		  function saveAndPrintCurrentPage(){
				...
				if(countDay > 10) {
			  	...
			  	if(checkTime() == false) {
					...
					window.belowFrame.location.href="cardInfoReport_carMonthBillReport.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value;
			    }
		  }
		  ...
		  function saveAndPrintPDF(){
		  	if(checkTime() == false) {
		    	...
		    	window.open("cardInfoReport_carMonthBillReportPDF.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value);
		    }
		  }
		  //校验日期
		  function checkTime() {
