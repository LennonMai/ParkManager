		  ...
		  function saveAndPrint() {
			...
			if(countDay > 10) {
		  	...
		  	if(checkTime() == false) {
			    ...
			    window.open("cardInfoReport_cardInfoReport.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value+"&param_parkReport.pvalue=${param_parkReport.pvalue}");
		    }
		  }
		...
		//生成当前页面HTML报表
			  ...
			  var countDay = compTime(get("startTime").value, get("endTime").value);
				if(countDay > 10) {
			  	...
			  	if(checkTime() == false) {
					...
					window.belowFrame.location.href="cardInfoReport_cardInfoReport.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value+"&param_parkReport.pvalue=${param_parkReport.pvalue}";
			    }
		  }
		  ...
		  function saveAndPrintPDF(){
		  	if(checkTime() == false) {
		    	...
		    	window.open("cardInfoReport_cardInfoReportPDF.do?startTime="+get("startTime").value+"&endTime="+get("endTime").value+"&param_parkReport.pvalue=${param_parkReport.pvalue}");
		    }
		  }
		  //校验日期
		  function checkTime() {
