	...
	<head>
		...
		<script type="text/javascript">
			if("${result}"=="SUCCESS")
				...
				alert("此类型卡已有此卡号");
			 function doPrint() { 
                     window.open("account_printPayment.do?account.sys_id=${account.sys_id}&accountTrade.seqNo=${accountTrade.seqNo}&account.balance=${account.balance}&accountTrade.fee=${accountTrade.fee}&accountTrade.balance=${accountTrade.balance}&accountTrade.tradeTime=${accountTrade.tradeTime}")
                    } 
