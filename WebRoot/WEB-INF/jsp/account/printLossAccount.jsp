...
<html>
	<head>
		...
		if("${result}"=="SUCCESS")
				alert("打印成功");
		function doPrint() { 
            window.open("account_printLoss.do?account.sys_id=${account.sys_id}")
           } 
        </script> 
			 ...
			 <form method="post" action="" >  
				 ...
				 <table width="100%" class="pn-ftable" cellpadding="2" cellspacing="1" border="0"  style="background-color: #FFFFFF;">
					...
					<td colspan="4" class="pn-fbutton">
							<input type="text" value=" 挂失帐户信息回执 " style="BORDER-BOTTOM: 0px; BORDER-LEFT: 0px; BACKGROUND: none transparent scroll repeat 0% 0%; BORDER-TOP: 0px; BORDER-RIGHT: 0px"/> &nbsp;
					</td>
					</tr>
					</table>                                    
					...
					<tr>
					  ...
					  <td class="pn-flabel pn-flabel-h">挂失时间</td>
					...
					<tr>
					   ...
					   <td class="pn-fcontent"><input type="text" name="account.openAccountTime" value="<fmt:formatDate value="${account.openAccountTime}" pattern="yyyy-MM-dd HH:mm:ss" />" readonly="true" style="BORDER-BOTTOM: 0px; BORDER-LEFT: 0px; BACKGROUND: none transparent scroll repeat 0% 0%; BORDER-TOP: 0px; BORDER-RIGHT: 0px"/></td>
