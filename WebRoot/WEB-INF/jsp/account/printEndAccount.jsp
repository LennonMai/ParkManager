			 ...
			 <form method="post" action="" >  
				 ...
				 <table width="100%" class="pn-ftable" cellpadding="2" cellspacing="1" border="0"  style="background-color: #FFFFFF;">
					...
					<td colspan="4" class="pn-fbutton">
							<input type="text" value=" 销户信息回执 " style="BORDER-BOTTOM: 0px; BORDER-LEFT: 0px; BACKGROUND: none transparent scroll repeat 0% 0%; BORDER-TOP: 0px; BORDER-RIGHT: 0px"/> &nbsp;
					</td>
					</tr>
					</table>                                    
					...
					<tr>
					  ...
					  <td class="pn-flabel pn-flabel-h">销户时间</td>
