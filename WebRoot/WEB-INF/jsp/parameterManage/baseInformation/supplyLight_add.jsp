...
<html>
	...
	<body>
		<div class="body-box">
			...
			<form id="dataform" method="post" action="baseInfo_saveSupplyLight.do" >
				<table width="100%" class="pn-ftable" cellpadding="2" cellspacing="1" border="0">
					<tr>
						<td class="pn-flabel pn-flabel-h">开始时间：</td>
						<td class="pn-fcontent"><input class="required maxlength8" style="width: 201px;" type="text" name="supplyLightInformation.startTime" value="${supplyLightInformation.startTime }"  class="Wdate" onclick="WdatePicker({dateFmt:'HH:mm:ss'})" readonly="readonly"/><span style="color: red">&nbsp;*</span></td>
