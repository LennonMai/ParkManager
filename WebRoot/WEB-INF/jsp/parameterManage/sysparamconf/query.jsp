...
<html>
	<head>
		...
		<script language="javascript">
	    	...
	    	//document.all.sysparamconfpname.value="";		    		    	
		    }
	...
	<body  onload="setRowBGcolor();">
		<div class="body-box">
			...
			<form  name="tableForm"  method="post" action="paramconf_query.do" >
			<table width="100%" class="pn-ftable" cellpadding="0" cellspacing="1" border="0">
				   				    <tr>
						<td  class="pn-flabel pn-flabel-h">参数名：</td>
						<td  class="pn-fcontent"> <input type="text" size="24"  name="sysparamconf.pname" value="${sysparamconf.pname}" /></td>
					...
					<tr>
						...
						<td  class="pn-fcontent"> <input type="text" size="24"   name="sysparamconf.pvalue" value="${sysparamconf.pvalue}" /></td>
						<td  class="pn-flabel pn-flabel-h">备&nbsp;&nbsp;注：</td>
						<td  class="pn-fcontent"><input type="text" size="24"   name="sysparamconf.remark" value="${sysparamconf.remark}" /></td>
					</tr>
					<tr>
				...
				<tbody class="pn-ltbody">
					<c:forEach items="${list}" var="item">
						<tr onmouseover="this.className='pn-lhover'" onmouseout="this.className=''" align="center"  onclick="getRowIndex(this)">
							...
							<td class="pn-lopt" style="white-space:nowrap;padding-left:5px;padding-right:5px;"><a href="javascript:edit(${item.sys_id},${pager.pageSize},${pager.currentPage})" class="pn-loperator">修改</a>
