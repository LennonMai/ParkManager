...
<html>
	...
	<body>
		<div class="body-box">
			...
			<form  name="tableForm"  method="post" action="laneOperatorPrivilege_query.do" onsubmit="">
			<table width="100%" class="pn-ftable" cellpadding="0" cellspacing="1" border="0">
					<tr>
					    <td  class="pn-flabel pn-flabel-h">操作员编码：</td>
						<td  class="pn-fcontent"> <input type="text" name="laneOperatorPrivilege.operatorNo" value="${laneOperatorPrivilege.operatorNo}" size="24"/></td>
						<td  class="pn-flabel pn-flabel-h">模块编码：</td>
						<td  class="pn-fcontent"> <input type="text" name="laneOperatorPrivilege.moduleNo" value="${laneOperatorPrivilege.moduleNo}" size="24"/></td>
					</tr>
					<tr>
