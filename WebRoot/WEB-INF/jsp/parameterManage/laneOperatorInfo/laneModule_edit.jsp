...
<html>
	...
	<body>
		<div class="body-box">
			...
			<form id="dataform" method="post" action="laneModule_update.do" >
				<table width="100%" class="pn-ftable" cellpadding="2" cellspacing="1" border="0">
					<tr>
						<td class="pn-flabel pn-flabel-h">模块编码：</td>
						<td style="width: 446px;" class="pn-fcontent"><input type="hidden" name="laneModule.moduleNo" value="${laneModule.moduleNo}" size="24"/>${laneModule.moduleNo}</td>
