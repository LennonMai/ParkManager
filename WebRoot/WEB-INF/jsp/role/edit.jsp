...
<html>
	...
	<body>
		<div class="body-box">
			...
			<form method="post" action="role_update.do?roleName=${role.name }" onsubmit="return check();">
				<table width="100%" class="pn-ftable" cellpadding="2" cellspacing="1" border="0">
					<tr>
						<td width="20%" class="pn-flabel pn-flabel-h">角色名称：</td>
						<td width="80%" class="pn-fcontent"><input type="text" name="role.name" size="50" value="${role.name}"/>&nbsp;<font style="color:red">*</font></td>
					</tr>
					<tr>
						<td width="20%" class="pn-flabel pn-flabel-h">备&nbsp;&nbsp;&nbsp;&nbsp;注：</td>
						<td width="80%" class="pn-fcontent"><textarea name="role.remark" rows="3" cols="100">${role.remark}</textarea></td>
					</tr>
					<tr>
						...
						<td width="80%" class="pn-fcontent">
							<div class="dtree">
								<script type="text/javascript">
									...
									document.write(d);
									<%--d.openAll();--%>
									d.setCheck("<c:forEach items="${role.modules}" var="module">,${module.id}</c:forEach>");
