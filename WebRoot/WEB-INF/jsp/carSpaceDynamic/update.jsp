...
<html>
	...
	<body>
		<div class="body-box">
			...
			<form id="dataform" method="post" action="carSpaceDynamic_updateCarSpaceDynamic.do">
				<table width="100%" class="pn-ftable" cellpadding="2" cellspacing="1" border="0">
				    <tr>
					    <td  class="pn-flabel pn-flabel-h">序号：</td>
						<td  class="pn-fcontent"> <input type="text" name="carSpaceDynamic.recNo" value="${carSpaceDynamic.recNo}" readonly="true" style="BORDER-BOTTOM: 0px; BORDER-LEFT: 0px; BACKGROUND: none transparent scroll repeat 0% 0%; BORDER-TOP: 0px; BORDER-RIGHT: 0px"></td>
						<td  class="pn-flabel pn-flabel-h">停车场编号：</td>
						<td  class="pn-fcontent"> <input type="text" name="carSpaceDynamic.parkNo" value="${carSpaceDynamic.parkNo}" class="required maxlengthTen" >&nbsp;<font style="color:red">*</font></td>																			 					
					</tr>
					<tr>
