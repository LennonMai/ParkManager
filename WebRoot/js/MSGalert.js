/*!
 * MSGalert
 * Copyright (c) 2011 Bruce Qin
 */

//显示层对象
var MSGalert = function(box, options){
	//初始化程序
...
//兼容ie6扩展
if ( $$B.ie6 ) { MSGalert.prototype._initialize = (function(){
	var init = MSGalert.prototype._initialize,
		methods = {
			"init": function(){
...
//居中扩展
MSGalert.prototype._initialize = (function(){
	var init = MSGalert.prototype._initialize,
		methods = {
			"init": function(){
...
var OverLay = function(){
	...
	function Create(){
		...
		overlay = new MSGalert( lay, { fixed: true } );
		Create = $$.emptyFunction;
	}
	return {
		"color":	"#fff",//背景色
