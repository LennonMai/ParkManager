...
public class PriceBase implements java.io.Serializable {
	...
	private Integer rebateType;//主键，优惠类型
	private Integer inOutSign;//主键，进出口标志
	private Integer timesSign;//主键，时间段标志
	private Integer vehTypeNo;//主键，车型1－摩托车 2－小车3－大型车4－超大型车
	...
	private Integer addStart;//单位时间起算时间
	...
	public PriceBase(Integer verNo, Integer feeNo, Integer rebateType,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PriceBase))
			return false;
		PriceBase castOther = (PriceBase) other;
