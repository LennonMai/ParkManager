...
public class AccountTrade implements Serializable {
	...
	//private Integer accountNo;//帐号(PK),是联合主键又是外键Account映射
	...
	public boolean equals(Object obj) {
       ...
       if(!(obj instanceof AccountTrade)) {
            return false;
        }	       
       AccountTrade accountTrade = (AccountTrade) obj;
        return new EqualsBuilder().append(this.account, accountTrade.getAccount()).append(this.seqNo, accountTrade.getSeqNo()).isEquals();       

    }
    public int hashCode() {
        return new HashCodeBuilder() .append(this.account).append(this.seqNo).toHashCode();
    }
